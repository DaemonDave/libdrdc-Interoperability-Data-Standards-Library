...
/**
	...
	This library by  by Marian Vittek, Bratislava, http://www.xref-tech.com/sglib, 2003-5
	encapsulates simple object types into  
	- linked lists
	- doubly-linked lists
	- hash table lists
	- queues
	
	using macro defines to generate various useful elements for the other library elements.
	
	These don't have to be used to make the other parts of the library function, but they can 
	improve uniformity.
...
/**
 * @addtogroup utils Object Utility API 
 */
/** @{ */
